...
> Le [[DigitalDivide|fossé numérique]] fait référence aux inégalités d'accès à la [[DigitalTechnology|technologie numérique]] et à l'[[Internet]], ainsi qu'aux compétences et à l'usage de ces technologies, entre différents individus, foyers, entreprises ou zones géographiques.
...
Le [[DigitalDivide|fossé numérique]] crée des [[SecurityVulnerabilities|vulnérabilités de sécurité]] significatives pour les individus et les organisations. Les personnes ayant un accès ou des compétences numériques limitées sont souvent moins conscientes des [[Threat|menaces]] en [[Cybersecurity|cybersécurité]] et des meilleures pratiques de [[Security|sécurité]]. Elles sont plus susceptibles de devenir des victimes de [[SocialEngineering|cyberattaques]] comme le [[Phishing|hameçonnage]] ou les [[Malware|logiciels malveillants]], car elles manquent de [[SecurityAwareness|sensibilisation à la sécurité]] de base et d'accès aux outils de [[EndpointProtectionPlatform|protection des endpoints]]. Cette disparité peut entraîner des [[FinancialLoss|pertes financières]], des [[DataTheft|vols de données personnelles]] et une [[ReputationalDamage|atteinte à la réputation]]. De plus, un manque d'inclusion numérique peut entraver la mise en œuvre de [[SecurityControl|contrôles de sécurité]] essentiels (par exemple, l'[[MultiFactorAuthentication|MFA]]) ou la capacité des victimes à signaler des [[IncidentResponse|incidents de sécurité]].
