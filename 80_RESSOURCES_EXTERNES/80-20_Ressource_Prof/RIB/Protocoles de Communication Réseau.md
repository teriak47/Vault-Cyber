...
Dans un environnement câblé ou sans fil, un réseau local est défini comme une zone où tous les hôtes doivent "parler le même langage", ce qui signifie qu'ils doivent partager un [[Protocol|protocole]] commun.
...
Comment un appareil sait-il à quel réseau il appartient ? Comment sait-il où envoyer les informations ? La réponse est : le [[Protocol|protocole]], les règles qui régissent comment les appareils communiquent.
