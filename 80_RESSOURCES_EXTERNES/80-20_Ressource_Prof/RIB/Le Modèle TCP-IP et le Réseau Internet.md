...
Les Modèle en couches nous aident à voir comment les divers [[Protocol|Protocole]] interagissent pour assurer les communications réseau. Un modèle en couches illustre le fonctionnement des protocoles dans chaque Couche, ainsi que l'interaction avec les couches supérieures et inférieures.
