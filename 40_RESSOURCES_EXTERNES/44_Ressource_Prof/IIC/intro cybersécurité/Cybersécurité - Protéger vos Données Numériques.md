...
OAuth (Open Authorization) est un [[Protocols|protocole]] ouvert normalisé qui permet à l'utilisateur final identifié d'accéder à des applications tierces sans exposer le mot de passe utilisateur.
