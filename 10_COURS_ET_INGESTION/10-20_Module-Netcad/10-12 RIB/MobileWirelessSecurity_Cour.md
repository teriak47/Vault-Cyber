...
Les appareils mobiles sont préprogrammés pour utiliser un réseau Wi-Fi pour l'internet s'il en existe un et que l'appareil peut se connecter au [[AccessPoint|point d'accès]] et recevoir une [[InternetProtocol|adresse IP]]. Si aucun réseau Wi-Fi n'est disponible, ils utilisent les données cellulaires, si cette fonctionnalité est configurée.
