...
La plupart des applications réseau se basent sur l'[[InternetProtocol|adresse IP]] logique de destination pour identifier l'emplacement des [[Server|serveurs]] et des [[Client|clients]].
