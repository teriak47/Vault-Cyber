...
Après avoir confirmé que l'ordinateur est connecté au routeur et que les voyants de liaison indiquent que la connexion fonctionne, l'ordinateur a besoin d'une [[InternetProtocol|adresse IP]].
*   La plupart des routeurs de réseau sont configurés pour que chaque ordinateur reçoive automatiquement une [[InternetProtocol|adresse IP]] via un [[DHCPServer|serveur DHCP]] local.
