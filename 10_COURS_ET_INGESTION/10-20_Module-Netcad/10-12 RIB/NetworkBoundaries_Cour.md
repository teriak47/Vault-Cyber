...
Le [[WirelessRouter|routeur sans fil]] joue le rôle de [[DHCPServer|serveur DHCP]] pour tous les [[Host|hôtes]] locaux qui y sont rattachés au moyen d'un [[EthernetPatchCable|câble Ethernet]] ou via une [[WirelessTransmission|connexion sans fil]].
