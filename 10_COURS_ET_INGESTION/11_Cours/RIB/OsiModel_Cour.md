...
- **7 - [[ApplicationLayer|Application]]**: La [[ApplicationLayer|couche application]] contient les [[Protocols|protocoles]] utilisés pour les communications de processus à processus.
